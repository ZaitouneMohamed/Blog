    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <img src="{{ asset('assets/images/contact.jpg') }}" alt="" class="img-fluid w-100">
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <form id="contact-form" class="contact-form" method="POST" action="{{route('send_message')}}">
                            @csrf
                            @method("get")
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-message" name="content"
