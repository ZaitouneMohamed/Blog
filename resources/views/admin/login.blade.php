...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="{{ asset('dashboards/adminlte/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
    <!-- Theme style -->
...
<body class="hold-transition login-page" style="background-color: rgb(29, 29, 29)">
    ...
    <!-- AdminLTE App -->
    <script src="{{ asset('dashboards/adminlte/dist/js/adminlte.min.js') }}"></script>
</body>
